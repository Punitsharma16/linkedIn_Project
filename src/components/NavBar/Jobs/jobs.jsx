            ...
            <aside className={style.midSection}>
                ...
                <section className={style.MidBody}>
                    ...
                    <div className={style.companyDetails}>
                        ...
                        <div>
                             <Link style={{fontSize:'18px',fontWeight:'500'}}>Frontend Developer</Link><br />
                    ...
                    <div className={style.companyDetails}>
                        ...
                        <div>
                             <Link style={{fontSize:'18px',fontWeight:'500'}}>Website Developer</Link><br />
                    ...
                    <div className={style.companyDetails}>
                        ...
                        <div>
                             <Link style={{fontSize:'18px',fontWeight:'500'}}>Wed Developer</Link><br />
